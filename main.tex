       ...
       \begin{columns}[t]
            \begin{column}{.5\textwidth}
                \begin{itemize}
                    ...
                    \item Center of gravity adjustable.
...
\begin{frame}[r]{Mechanical Design - Camera rotator}
    \begin{columns}[t]
            \begin{column}{.5\textwidth}
                \begin{itemize}
...
\begin{frame}[r]{Mechanical Design - Interface}
    \begin{columns}[t]
            \begin{column}{.5\textwidth}
                \begin{itemize}
...
\begin{frame}[r]{Mechanical Design - Verification}
    \begin{columns}[t]
            \begin{column}{.5\textwidth}
                \begin{itemize}
