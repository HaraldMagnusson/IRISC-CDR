...
\begin{frame}[c]{Control system - Risks}
    \begin{itemize}
        ...
        \rotatebox[origin=c]{180}{$\Lsh$} Solutions: Analitical approach; Various tests on both model and prototype; \\ \hspace{58px}Consulation with our mentor, who's a specialist in control field.
    \end{itemize}
\end{frame}
